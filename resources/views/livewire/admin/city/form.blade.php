    ...
    <div class="statbox widget box box-shadow">
        ...
        <div class="widget-content widget-content-area">
            <form wire:submit="submit(Object.fromEntries(new FormData($event.target)))">
                <div class="row mb-4">
                    <div class="col-sm-12">
                        <label for="name" class="form-label">اسم شهر :</label>
                ...
                <div class="row mb-4">
                    <div class="col-sm-12">
                        <label for="stateId" class="form-label">اسم استان :</label>
                        <select id="select-beast" name="stateId" wire:model="stateId" class="form-control" wire:ignore
                                placeholder=""
                                autocomplete="off">
