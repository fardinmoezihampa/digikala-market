    ...
    <div class="statbox widget box box-shadow">
        ...
        <div class="widget-content widget-content-area">
            <form wire:submit="submit(Object.fromEntries(new FormData($event.target)))">
                <div class="row mb-4">
                    <div class="col-sm-12">
                        <label for="name" class="form-label">اسم استان :</label>
                ...
                <div class="row mb-4">
                    <div class="col-sm-12">
                        <label for="countryId" class="form-label">اسم کشور :</label>
                        <select id="select-beast" name="countryId" wire:model="countryId" class="form-control" wire:ignore
                                placeholder=""
                                autocomplete="off">
                            <option value="">انتخاب نام کشور...</option>
